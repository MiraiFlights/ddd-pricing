...
final class FlightArrivalCityCondition implements FlightConditionInterface
{
    ...
    {
        $result = in_array($this->helper->getCityIdByICAO($flight->getRoute()->getArrivalICAO()), (array)$value['array']);
