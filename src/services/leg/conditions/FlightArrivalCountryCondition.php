...
final class FlightArrivalCountryCondition implements FlightConditionInterface
{
    ...
    {
        $result = in_array($this->helper->getCountryISO3ByICAO($flight->getRoute()->getArrivalICAO()), (array)$value['array']);
