    ...
    public function jsonSerialize(): mixed
    {
        return array_merge(
            [
                ...
                'currency' => $this->getProperties()->getPrice()?->getCurrency()->value,
                'percent' => $this->getProperties()->getPercent(),
                'pricingProfileId' => $this->getProperties()->getAircraftPricingProfileID()?->getValue(),
            ],
            array_filter([
